...
namespace CalendarData
{
    ...
    class CityData
    {
        public static void FindClosestCity( double latitude, double longtitude)
        {
            LatLong[] latLongData = {
            ...
            ComputeDistance(-33.86962890625, 151.20695495605469, -37.817531585693359, 144.96714782714844); 
            ComputeDistance(40.714550018310547, -74.007118225097656, 47.603561401367188, -122.32943725585938);
            //ComputeDistance(-36.884109497070312, 174.77041625976563, 1.2901599407196045, 103.85199737548828);
        }

        public static void ComputeDistance(double lat1, double long1, double lat2, double long2)
        {
            double R = 3960; // km
            ...
            double d = R * c;
            Console.WriteLine("Distance d is {0}", d);
        }
